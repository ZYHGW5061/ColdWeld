            ...
            while (true)
            {
                ...
                else
                {
                    ...
                    actionQueue.Enqueue(new ComponentTransferInfo()
                    {
                        ...
                        TransferAction = EnumTransferAction.PositionComponent,
                        Component = nextComponentInfo
                    });
                    actionQueue.Enqueue(new ComponentTransferInfo()
                    {
                        UsedPP = EnumUsedPP.ChipPP,
                        TransferAction = EnumTransferAction.PickComponent,
                        Component = nextComponentInfo
                    });
                    actionQueue.Enqueue(new ComponentTransferInfo()
                    {
                        UsedPP = EnumUsedPP.ChipPP,
                        TransferAction = EnumTransferAction.AccuracyComponentPosition,
                        Component = nextComponentInfo
                    });
                    actionQueue.Enqueue(new ComponentTransferInfo()
                    {
            ...
            while (true)
            {
                ...
                else
                {
                    ...
                    actionQueue.Enqueue(new SubmountTransferInfo()
                    {
                        ...
                        TransferAction = EnumTransferAction.PositionSubmountBeforePickFromSubstrate,
                        Component = nextSubmountInfo
                    });
                    actionQueue.Enqueue(new SubmountTransferInfo()
                    {
                        UsedPP = EnumUsedPP.SubmountPP,
                        TransferAction = EnumTransferAction.PickSubmountFromSubstrate,
                        Component = nextSubmountInfo
                    });
                    actionQueue.Enqueue(new SubmountTransferInfo()
                    {
                        UsedPP = EnumUsedPP.SubmountPP,
                        TransferAction = EnumTransferAction.AccuracySubmountPosition,
                        Component = nextSubmountInfo
                    });
                    actionQueue.Enqueue(new SubmountTransferInfo()
                    {
                        UsedPP = EnumUsedPP.SubmountPP,
                        TransferAction = EnumTransferAction.PlaceSubmounttoChuck,
                        Component = nextSubmountInfo
                    });
                    actionQueue.Enqueue(new SubmountTransferInfo()
                    {
                        UsedPP = EnumUsedPP.SubmountPP,
                        TransferAction = EnumTransferAction.PositionBeforeBond,
                        Component = nextSubmountInfo
                    });
                    actionQueue.Enqueue(new SubmountTransferInfo()
                    {
                        UsedPP = EnumUsedPP.SubmountPP,
                        TransferAction = EnumTransferAction.PositionSubmountBeforePickFromChuck,
                        Component = nextSubmountInfo
                    });
                    actionQueue.Enqueue(new SubmountTransferInfo()
                    {
                        UsedPP = EnumUsedPP.SubmountPP,
                        TransferAction = EnumTransferAction.PickSubmountFromChuck,
                        Component = nextSubmountInfo
                    });
                    actionQueue.Enqueue(new SubmountTransferInfo()
                    {
                    ...
                    {
                        UsedPP = EnumUsedPP.SubmountPP,
                        TransferAction = EnumTransferAction.PlaceSubmounttoSubstrate,
                        Component = nextSubmountInfo
                    });
                }
            }
